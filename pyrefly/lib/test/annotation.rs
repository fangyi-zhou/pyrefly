...
bad2: int | "str" | T = "foo"  # E: `|` union syntax does not work with string literals # E: Type variable `T` is not bound in this scope
bad3: "str" | int = "foo"  # E: `|` union syntax does not work with string literals
bad4: "str" | int | T = "foo"  # E: `|` union syntax does not work with string literals # E: Type variable `T` is not bound in this scope
bad5: C | "str" = "foo"  # E: `|` union syntax does not work with string literals
ok1: T | "str" = "foo"  # E: Type variable `T` is not bound in this scope
ok2: "str" | T = "foo"  # E: Type variable `T` is not bound in this scope
ok3 = list["str" | T]
ok4 = (int) | (str)
ok5: "str" | C[int] = "foo"
ok6: C[int] | "str" = "foo"
